...
contract DEX {
    ...
    function tokenToEth(uint256 tokenInput) public returns (uint256 ethOutput) {
        require(tokenInput > 0, "Amount must be greater than 0");
        uint256 yOutput = price(tokenInput, totalLiquidity, address(this).balance);
        ethOutput = yOutput;
    ...
    function withdraw(uint256 amount) public returns (uint256 ethAmount, uint256 tokenAmount) {
        ...
        tokenAmount = (amount * totalLiquidity) / liquidity[msg.sender];
